  ...
  : Binder, IAutoBinder
{
  ...
  public virtual TType CreateInstance<TType>(AutoGenerateContext context)
  {
    ...
    return (TType)CreateInstance(type, context);
  }

  /// <summary>
  /// Creates an instance based on the <see cref="AutoGenerateOverrideContext"/>.
  /// </summary>
  /// <param name="context">The <see cref="AutoGenerateOverrideContext"/> instance for the generate request.</param>
  /// <returns>The created instance.</returns>
  public virtual object CreateInstance(AutoGenerateOverrideContext context)
  {
    return CreateInstance(context.GenerateType, context.GenerateContext);
  }

  /// <summary>
  /// Creates an instance of System.Type.
  /// </summary>
  /// <param name="context">The <see cref="AutoGenerateContext"/> instance for the generate request.</param>
  /// <returns>The created instance of <typeparamref name="TType"/>.</returns>
  public virtual object CreateInstance(Type type, AutoGenerateContext context)
  {
  ...
  /// </remarks>
  public virtual void PopulateInstance<TType>(object instance, AutoGenerateContext context,
    IEnumerable<MemberInfo> members = null)
  {
    var type = typeof(TType);
    PopulateInstance(type, instance, context, members);
  }

  public virtual void PopulateInstance(object instance, AutoGenerateContext context, IEnumerable<MemberInfo> members = null)
  {
    var type = instance.GetType();
    PopulateInstance(type, instance, context, members);
  }

  protected virtual void PopulateInstance(Type type, object instance, AutoGenerateContext context, IEnumerable<MemberInfo> members = null)
  {
  ...
  private IEnumerable<AutoMember> GetMembersToPopulate(Type type, IEnumerable<MemberInfo> members)
  {
    ...
    foreach (var member in type.GetMembers(BindingFlags))
    {
      ...
      switch (autoMember.IsReadOnly)
      {
        // A readonly dictionary or collection member can use the Add() method
        case true when ReflectionHelper.IsDictionary(autoMember.Type):
        case true when ReflectionHelper.IsCollection(autoMember.Type):
